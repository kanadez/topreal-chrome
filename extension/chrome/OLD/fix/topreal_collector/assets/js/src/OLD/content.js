...
var select_mode = 1; // 0 - selecting elements off, 1 - on
var turned_on = 0;
var no_translate_mode = 0;
var default_collector = 32;// сюда доджен читаться номер купленного и выбранного в Tools коллектора
//$('head').append("<script type='text/javascript' src='//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit'>");
//var host = null;

if (location.origin === "http://www.yad2.co.il" && location.pathname === "/Nadlan/salesDetails.php"){ // если НА странице обявления Яд2
	toggleExtension();
	select_mode = 0;
}
...
function startExtension(){ 
    ...
    $(document.body).append(
        '<div id="buttons_div" translate="no" title="TopReal Collector" style="display:none;text-align;center;">\n\
            ...
            <input style="display:none" style="width:100%" id="upload_collector_locale_input" type="file" name="file" accept=".csv" multiple="multiple" data-url="http://topreal.top/storage/upload.php" />\n\
            ...
            <a style="display:none" id="collector_locale_download_a" href="http://topreal.top/storage/collector_locale.csv" style="display:none;">Download collector locale</a>\n\
	...
	if (location.pathname !== "/Nadlan/salesDetails.php"){ //если НЕ на странице обявления Яд2
    ...
    $('#try_collector_button').click(function(){
        builder.tryCollector(default_collector);
    });
